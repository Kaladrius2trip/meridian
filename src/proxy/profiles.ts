...
/** Reset disk auto-discovery — for testing only. Tests that boot the real CLI
 *  (runCli) flip the flag on process-wide; without a reset every later test
 *  file resolves the host's real profiles. */
